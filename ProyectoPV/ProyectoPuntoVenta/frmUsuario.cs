...
namespace ProyectoPuntoVenta
{
    public partial class frmUsuario : Form
    {
        ...
        private void frmUsuario_Load(object sender, EventArgs e)
        {
            ...
            dgdata.Columns.Add("Username", "Username");
            ...
            dgdata.Columns["Username"].Visible = true;
            ...
            foreach (Persona p in PersonaLogica.Instancia.Listar().Where(p => p.oTipoPersona.IdTipoPersona != 3).ToList())
            {
                ...
                row.Cells["Username"].Value = p.Username;
            }
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            if (int.Parse(txtid.Text) == 0)
            {
                ...
                if (resultado)
                {
                    ...
                    row.Cells["Username"].Value = this.textBox1.Text;
                }
