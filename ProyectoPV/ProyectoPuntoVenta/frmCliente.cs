...
namespace ProyectoPuntoVenta
{
    public partial class frmCliente : Form
    {
        ...
        private void frmCliente_Load(object sender, EventArgs e)
        {
            ...
            foreach (Persona p in PersonaLogica.Instancia.Listar().Where(p=> p.oTipoPersona.IdTipoPersona == 3 ||  p.oTipoPersona.IdTipoPersona == 2).ToList()) {
        ...
        private void dgdata_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgdata.Columns[e.ColumnIndex].Name == "btnSeleccionar")
            {
                ...
                if (index >= 0)
                {
                    ...
                    this.textBox1.Text= dgdata.Rows[index].Cells["Cupo"].Value.ToString();
                }
            }
        }
        ...
        {
            using (var form = new ModalSaldos())
            {
                form.NumDoc = txtdocumento.Text;
                form.VarNombre = txtnombre.Text;
