...
namespace ProyectoPuntoVenta
{
    public partial class ModalPersona : Form
    {
        ...
        private void ModalPersona_Load(object sender, EventArgs e)
        {
            ...
            dgdata.Columns.Add("Saldo", "Saldo");
            ...
            dgdata.Columns["Saldo"].Width = 200;
        ...
        private void dgdata_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgdata.Columns[e.ColumnIndex].Name == "btnSeleccionar")
            {
                ...
                if (index >= 0)
                {
                    ...
                    Cupo = dgdata.Rows[index].Cells["Cupo"].Value.ToString();
                    Saldo = dgdata.Rows[index].Cells["Saldo"].Value.ToString();
